...
TARGET_EXTRA_CFLAGS=
TARGET_EXTRA_LDFLAGS="-Wl,-z,max-page-size=16384"
TARGET_DEP_LIBS=
TARGET_CLANG_PREFIX=
...
TARGET_TOOLCHAIN_PATH=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64
...
. $TARGET_BUILD_ROOT/../../config/module-tv.sh
